...
var setTrafficLight = function () {
    var red_phase = parseInt($('#red_phase').val()) || parseInt(getParameterByName('red')) || parseInt(getParameterByName('red_phase')) || 0;
    var green_phase = parseInt($('#green_phase').val()) || parseInt(getParameterByName('green')) || parseInt(getParameterByName('green_phase')) || 0;
